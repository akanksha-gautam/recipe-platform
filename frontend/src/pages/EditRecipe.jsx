...
const EditRecipe = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setError(
        err.response?.data?.message || 'Failed to update recipe. Please check your inputs.'
      );
    } finally {
      setSaving(false);
    }
  ...
  if (loading) {
    return (
      <div className="max-w-3xl mx-auto px-6 py-12 flex-grow shimmer">
        ...
        <div className="h-64 bg-black/5 dark:bg-white/5 rounded-3xl" />
      </div>
    );
  }
    ...
    <div className="max-w-3xl mx-auto px-6 py-8 flex-grow">
      ...
      <div className="glass p-8 rounded-3xl shadow-2xl relative overflow-hidden">
        ...
        <div className="mb-8 border-b border-black/5 dark:border-white/5 pb-4">
          <h1 className="text-3xl font-extrabold text-gray-800 dark:text-white">Edit Recipe</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm">
            Modify details and publish updates for your recipe.
          </p>
        </div>
